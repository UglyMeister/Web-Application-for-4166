...
var emojiText = "placeholder";
var bText = "placeholder";
var blbText = "placeholder";
var patrickText = "placeholder";

//follows the model set by item.js
var shaggy = item.newItem(1,"Shaggy","Modern",shaggyText);
var emoji = item.newItem(2,"Emoji","Modern",emojiText);
var b = item.newItem(3,"B","Modern",bText,"0");
var doge = item.newItem(4,"DOGE","Classic",dogeText);
var blb = item.newItem(5,"Bad Luck Brian","Classic",blbText);
var patrick = item.newItem(6,"Patrick and Spongebob","Classic",patrickText);
